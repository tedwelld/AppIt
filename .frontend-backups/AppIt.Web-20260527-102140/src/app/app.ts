...
export class App implements OnDestroy {
  ...
  trackByGroup(_: number, group: NavGroup): string {
    return group.id;
  }
  ...
  faIcon(icon: string): string {
    const icons: Record<string, string> = {
      account_tree: 'fas fa-fw fa-sitemap',
      dashboard: 'fas fa-fw fa-tachometer-alt',
      forum: 'fas fa-fw fa-comments',
      login: 'fas fa-fw fa-sign-in-alt',
      monitoring: 'fas fa-fw fa-chart-line',
      person: 'fas fa-fw fa-user',
      precision_manufacturing: 'fas fa-fw fa-cogs',
      settings: 'fas fa-fw fa-cog',
      space_dashboard: 'fas fa-fw fa-columns'
    };

    return icons[icon] ?? 'fas fa-fw fa-circle';
  }
