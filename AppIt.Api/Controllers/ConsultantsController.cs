    ...
    public class ConsultantsController : ControllerBase
    {
        ...
        public async Task<IActionResult> GetAll([FromQuery] ListQueryOptions query)
        {
            ...
            return Ok(items.ApplyQuery(query,
                nameof(ConsultantReadDto.FirstName),
                nameof(ConsultantReadDto.LastName),
                nameof(ConsultantReadDto.Email)));
        }
        ...
        [HttpPut("{id:int}")]
        [Authorize(Roles = "super,admin")]
        public async Task<IActionResult> Update(int id, [FromBody] UpdateConsultantDto dto)
        {
